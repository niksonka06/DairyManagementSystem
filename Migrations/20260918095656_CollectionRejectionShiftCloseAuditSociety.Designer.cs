...
namespace DairyManagementSystem.Migrations
{
    ...
    [Migration("20260918095656_CollectionRejectionShiftCloseAuditSociety")]
    partial class CollectionRejectionShiftCloseAuditSociety
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
                    ...
                    b.ToTable("MilkCollections", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_MilkCollections_Rejection", "([IsRejected] = 0 AND [RatePerLitre] > 0) OR ([IsRejected] = 1 AND [RatePerLitre] = 0 AND [Amount] = 0)");
            ...
            modelBuilder.Entity("DairyManagementSystem.Models.Entities.ShiftClose", b =>
                {
                    b.Property<int>("ShiftCloseID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ShiftCloseID"));
                    ...
                    b.HasKey("ShiftCloseID");

                    b.HasIndex("ClosedBy");

                    b.HasIndex("SocietyID", "CollectionDate", "Shift")
                        .IsUnique();

                    b.ToTable("ShiftCloses");
                });
            ...
            modelBuilder.Entity("DairyManagementSystem.Models.Entities.ShiftClose", b =>
                {
                    b.HasOne("DairyManagementSystem.Models.Entities.ApplicationUser", "ClosedByUser")
                        .WithMany()
